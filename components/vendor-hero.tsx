      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-femfuel-medium mb-6 max-w-2xl mx-auto">
            Conecta con miles de clientes, gestiona tu agenda y haz crecer tus ingresos. Comienza gratis. Solo 8% de comisión cuando ganes.
          </p>
          ...
          <div className="flex items-center justify-center gap-4 mb-8">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-femfuel-medium">50+ proveedores registrados</span>
            </div>
          </div>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/register" className="femfuel-button-lg">
